// ======================================================
// ⚙️ MT DEALS — APP LOGIC (MAXIMUM PERFORMANCE)
// ======================================================
...
function generateCardHTML(p, isFeatured) {
    ...
    // Thêm decoding="async" để không block cuộn khi load ảnh
    return `
...
function setupEventListeners() {
    ...
    // TỐI ƯU BACK-TO-TOP SCROLL LISTENER bằng Passive & RequestAnimationFrame
    ...
    if (btt) {
        ...
        }, { passive: true }); // Chống block touch scrolling
...
function initScrollAnimations() {
    ...
    if (!globalCardObserver) {
        ...
        // Tăng rootMargin cực lớn (300px) để tải trước khi user cuộn tới.
        // Giúp loại bỏ hoàn toàn cảm giác "chờ thẻ hiện ra".
    ...
    newCards.forEach((card) => {
        // Loại bỏ hoàn toàn JS Stagger Delay & setStyle inline.
