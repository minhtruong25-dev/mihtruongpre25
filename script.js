// ======================================================
// ⚙️ MT DEALS — APP LOGIC (PERFORMANCE & MICRO-INTERACTIONS)
// ======================================================
...
// Global Observers (Nhẹ, khởi tạo 1 lần)
...
function initScrollAnimations() {
        ...
        globalRevealObserver = new IntersectionObserver((entries, obs) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    // Gỡ bỏ observer ngay khi kích hoạt để giải phóng RAM
                    obs.unobserve(entry.target); 
                }
            });
        }, { 
            // CỰC KỲ QUAN TRỌNG: Mở rộng vùng margin xuống tận 800px.
            // Trình duyệt sẽ phát hiện và chạy animation trước khi ngón tay bạn vuốt tới.
            // Điều này triệt tiêu hoàn toàn cảm giác "phải đợi thẻ render".
    ...
    newCards.forEach((card) => {
        // Hoàn toàn KHÔNG tính toán JS Delay, KHÔNG dùng setTimeout
