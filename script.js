// ======================================================
// ⚙️ MT DEALS — APP LOGIC (PERFORMANCE OPTIMIZED V3)
// ======================================================
...
// Global Observers (Chỉ khởi tạo 1 lần)
...
function renderProducts() {
    ...
    // Đẩy xử lý observe ra khỏi luồng render chính
...
// =====================================================
// SCROLL REVEAL (TỐI ƯU HIỆU SUẤT CAO NHẤT)
// =====================================================
function initScrollAnimations() {
        ...
        globalCardObserver = new IntersectionObserver((entries, obs) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    // Không dùng setTimeout hay sửa JS inline style ở đây nữa.
                    // Card tự động fade-in bằng CSS thuần túy đảm bảo 60fps.
    ...
    newCards.forEach((card) => {
        // Loại bỏ hoàn toàn JS Stagger Delay.
        // Việc sửa đổi inline styles trên 50 phần tử ngay lúc scroll
        // là nguyên nhân cốt lõi gây Block Main Thread & Reflow trên Mobile.
